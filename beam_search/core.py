...
from beam_search.data_structs import *
# NOTE: for all users, import the instantiated versions of the stubs here
from beam_search.graph_setup import BeamSearchGraphGenerator
import json
    ...
    def beam_search(self):
        ...
        for idx in range(len(self.conversations)):
            ...
            if self.build_graph:
                ...
                self.graph_gen.graph.render(f"{self.graph_file}_{idx}.gv", view=True)
        ...
        with open("output_stats.json", "w") as out:
